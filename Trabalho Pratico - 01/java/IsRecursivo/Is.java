class Is {
    ...
    static boolean isVogal(String frase, int inicio){
        ...
        {
            if(frase.charAt(inicio) != 'A' && frase.charAt(inicio) != 'E'
                && frase.charAt(inicio) != 'I' && frase.charAt(inicio) != 'O'
                && frase.charAt(inicio) != 'U' && frase.charAt(inicio) != ' '
                && frase.charAt(inicio) != 'a' && frase.charAt(inicio) != 'e'
                && frase.charAt(inicio) != 'i' && frase.charAt(inicio) != 'o'
                && frase.charAt(inicio) != 'u')
            {
                isVogal = false;
            }
            else {
    ...
    static boolean isConsoante(String frase, int inicio) {
        ...
        if(inicio < frase.length())
        {
            if( (int)frase.charAt(inicio) >= 66 && (int)frase.charAt(inicio) <= 122
                    && frase.charAt(inicio) != 'E' && frase.charAt(inicio) != 'I' && frase.charAt(inicio) != 'O'
                    && frase.charAt(inicio) != 'U' && frase.charAt(inicio) != 'e' && frase.charAt(inicio) != 'a'
                    && frase.charAt(inicio) != 'i' && frase.charAt(inicio) != 'o' && frase.charAt(inicio) != 'u')
            {
                isConsoante = isConsoante(frase, inicio+1);
            }
            else
            {
                isConsoante = false;
    ...
    static boolean isReal(String frase, int inicio, int qnt){
        boolean isReal = true;
        if(inicio < frase.length()){
            if((int)frase.charAt(inicio) >= 48 && (int)frase.charAt(inicio) <= 57){
                isReal = isReal(frase, inicio+1, qnt);
            }
            else if(frase.charAt(inicio) == '.' || frase.charAt(inicio) == ','){
                isReal = isReal(frase, inicio+1, qnt+1);
            }
            else{
                isReal = false;
            }
