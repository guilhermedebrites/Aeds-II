    ...
    public static void main(String args[]){
        ...
        try{
            ...
            for(int i = 0; i < number; i++){
                ...
                switch(metodo[0]){
                    case "II":
                        lista.inserirInicio(personagens.get(UUID.fromString(metodo[1])));
                        break;
                    case "IF":
                        lista.inserirFim(personagens.get(UUID.fromString(metodo[1])));
                        break;
                    case "I*":
                        lista.inserir(personagens.get(UUID.fromString(metodo[2])), Integer.parseInt(metodo[1]));
                        break;
                    case "RI":
                        Personagem removidoInicio = lista.removerInicio();
                        System.out.println("(R) " + removidoInicio.getName());
                        break;
                    case "RF":
                        Personagem removidoFim = lista.removerFim();
                        System.out.println("(R) " + removidoFim.getName());
                        break;
                    case "R*":
                        Personagem removido = lista.remover(Integer.parseInt(metodo[1]));
...
class Lista {
    ...
    public Personagem removerInicio() throws Exception{
        ...
        Personagem personagem = primeiro.elemento;
        tmp.prox = null;
        tmp = null;
        return personagem;
    }
