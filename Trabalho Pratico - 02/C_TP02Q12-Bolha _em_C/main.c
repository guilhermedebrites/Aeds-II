...
void ordenaBolha(Personagem *personagem, int n){
    for(int i = (n-1); i > 0; i--){
        for(int j = 0; j < i; j++){
            if(strcmp(personagem[j].hairColour, personagem[j+1].hairColour) > 0){
                Personagem temp;
                clone(&personagem[j], &temp);
                clone(&personagem[j+1], &personagem[j]);
                clone(&temp, &personagem[j+1]);
            }
            if(strcmp(personagem[j].hairColour, personagem[j+1].hairColour) == 0){
                if(strcmp(personagem[j].nome, personagem[j+1].nome) > 0){
                    Personagem temp;
                    clone(&personagem[j], &temp);
                    clone(&personagem[j+1], &personagem[j]);
                    clone(&temp, &personagem[j+1]);
...
int main() {
    ...
    ordenaBolha(arrayPersonagem, tamArray);
