...
public class Personagem{
    ...
    public static void main(String args[]){
        ...
        try{
            ...
            ordenarHeapSort(arrayPersonagens);
    ...
    static void reconstruir(ArrayList<Personagem> personagens, int n, int i) {
        int maior = i;
        int esquerda = 2 * i + 1;
        int direita = 2 * i + 2;
    
        if (esquerda < n) {
            boolean isGreaterHairColour = personagens.get(esquerda).getHairColour().compareTo(personagens.get(maior).getHairColour()) > 0;
            boolean isEqualHairColour = personagens.get(esquerda).getHairColour().compareTo(personagens.get(maior).getHairColour()) == 0;
            boolean isGreaterName = personagens.get(esquerda).getName().compareTo(personagens.get(maior).getName()) > 0;
    
            if (isGreaterHairColour || (isEqualHairColour && isGreaterName)) {
                maior = esquerda;
            }
        }
    
        if (direita < n) {
            boolean isGreaterHairColour = personagens.get(direita).getHairColour().compareTo(personagens.get(maior).getHairColour()) > 0;
            boolean isEqualHairColour = personagens.get(direita).getHairColour().compareTo(personagens.get(maior).getHairColour()) == 0;
            boolean isGreaterName = personagens.get(direita).getName().compareTo(personagens.get(maior).getName()) > 0;
        ...
        if (maior != i) {
            ...
            personagens.set(i, personagens.get(maior));
            personagens.set(maior, swap);
            reconstruir(personagens, n, maior);
        }
    }
    
    public static void ordenarHeapSort(ArrayList<Personagem> personagens) {
        int n = personagens.size();
        for (int i = n / 2 - 1; i >= 0; i--) {
            reconstruir(personagens, n, i);
        }
